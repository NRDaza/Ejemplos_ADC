// ======================================================================
// ADC_LM35.v generated from TopDesign.cysch
// 02/12/2019 at 12:35
...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("af86b830-03b9-4f8b-bbdf-15ee36bb2687/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("af86b830-03b9-4f8b-bbdf-15ee36bb2687/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("1955fe2b-9d25-470c-b4b9-50a50e11e167"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1fbcb290-fd7f-4cff-a101-dc972ff6841e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("94337186-9c34-471c-ad1f-146a9e20858a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("30675efa-6471-4812-abad-df3efcb30d6c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b635a676-f301-49a2-8549-a0189599bae8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LM35_in2_net;
	wire [0:0] tmpFB_0__LM35_in2_net;
	wire [0:0] tmpIO_0__LM35_in2_net;
	wire [0:0] tmpINTERRUPT_0__LM35_in2_net;
	electrical [0:0] tmpSIOVREF__LM35_in2_net;

	cy_psoc3_pins_v1_10
		#(.id("dba895cb-1ddf-4588-bcbf-4a47baeee04c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LM35_in2
		 (.oe(tmpOE__LM35_in2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LM35_in2_net[0:0]}),
		  .analog({Net_28}),
		  .io({tmpIO_0__LM35_in2_net[0:0]}),
		  .siovref(tmpSIOVREF__LM35_in2_net),
		  .interrupt({tmpINTERRUPT_0__LM35_in2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LM35_in2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
