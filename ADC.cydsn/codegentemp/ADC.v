...
module ADC_DelSig_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("9ddd5234-ebd6-40e0-a850-78dfd7b47736/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("9ddd5234-ebd6-40e0-a850-78dfd7b47736/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__PinAnalog_net;
	wire [0:0] tmpFB_0__PinAnalog_net;
	wire [0:0] tmpIO_0__PinAnalog_net;
	wire [0:0] tmpINTERRUPT_0__PinAnalog_net;
	electrical [0:0] tmpSIOVREF__PinAnalog_net;
	...
	cy_psoc3_pins_v1_10
		...
		PinAnalog
		 (.oe(tmpOE__PinAnalog_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PinAnalog_net[0:0]}),
		  .analog({Net_1}),
		  .io({tmpIO_0__PinAnalog_net[0:0]}),
		  .siovref(tmpSIOVREF__PinAnalog_net),
		  .interrupt({tmpINTERRUPT_0__PinAnalog_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PinAnalog_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("49adfb84-1358-40f3-bb0d-5d760dda7c92"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d6e4798b-80aa-4f4e-858d-6cb7f7453775"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("448a38fc-13fe-4c9f-8a78-f71bcb493e64"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("540ac996-9fa3-4422-84d0-9141531c1c3c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cc0e8123-4ee3-494a-8004-cefb695470c2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
